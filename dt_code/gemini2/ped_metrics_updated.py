...
if __name__ == "__main__":
    process_all_instances(
        data_path_ST='Data/llm_output/gpt/gpt_baseline_1.jsonl',
        data_path_JUDGE='Data/llm_output/gpt/gpt_baseline_2.jsonl',
        data_path_OURS='Data/llm_output/gpt/gpt_ours.jsonl',
