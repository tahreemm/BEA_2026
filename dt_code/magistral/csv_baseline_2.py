...
def main():
    ...
    input_path = 'Data/llm_output/magistral/magistral_baseline_2.jsonl'
    record_number = None
    all_rows = []
    with open(input_path, 'r') as f:
        ...
        for line in f:
            ...
            row_data["judge_completion_tokens"] = [completion_tokens[0]] 
            row_data["judge_completion_time"] = [completion_time[0]]
            ...
            row_data["judge_student_update_completion_tokens"] = [completion_tokens[1]] 
            print("judge student update completion tokens: ", completion_tokens[1])
            row_data["judge_student_update_completion_time"] = [completion_time[1]]   
            print("judge student update completion time: ", completion_time[1])
        ...
        print(df.shape)
        df.to_csv("Data/csv/magistral/magistral_baseline_2.csv", index=False)
