...
from dt_code.magistral.magistral_interface import make_student_call, make_teacher_only_call, make_judge_only_call, make_judge_verifier_call, make_student_update_call
...
def append_output_line(outfile, id, problem_number, stepPreState, givens, conclusion, intermediates, correct_step, student_response, known_expressions, teacher_response, judge_response, student_update_response, cleaned_kg_final_steps, completion_tokens, total_tokens, time_taken):
    try:
...
def main():
    ...
    input_path = 'Data/llm_output/magistral/magistral_baseline_1.jsonl'
    output_path = 'Data/llm_output/magistral/magistral_ours.jsonl'
    ...
    with open(input_path, 'r') as infile:
        ...
        for line in infile:
            ...
            try:
                ...
                id = data.get('id', '')  # Track actual file line number
            ...
            append_output_line(output_path, id, problem_number, stepPreState, givens, conclusion, intermediates, correct_step, student_response, known_expressions, teacher_response, judge_response, student_update_response, cleaned_kg_final_steps, completion_tokens, total_tokens, time_taken)
