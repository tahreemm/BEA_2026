...
if __name__ == "__main__":
    process_all_instances(
        data_path_ST='Data/llm_output/mistral/mistral_baseline_1.jsonl',
        data_path_JUDGE='Data/llm_output/mistral/mistral_baseline_2.jsonl',
        data_path_OURS='Data/llm_output/mistral/mistral_ours.jsonl',
        output_path='Data/llm_output/mistral/mistral_metrics_results.csv',
        use_bertscore=True,
        device='cpu'
    )