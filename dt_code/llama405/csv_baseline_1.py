...
def main():
    ...
    input_path = 'Data/llm_output/gpt_baseline_1.jsonl'
    record_number = None
    missed_lines = [1, 5, 15, 22, 23, 24, 25, 27, 28, 30, 31, 32, 33, 34, 39, 42, 43, 46, 47, 50, 51, 52, 53, 54, 55, 56, 58, 59, 60, 61, 62, 63, 65, 66, 67, 71, 72, 76, 78, 80, 81, 83, 85, 90, 91, 93, 94, 103, 104, 105, 107, 108, 111, 113, 114, 117, 120, 121, 122, 124, 125, 126, 128, 129, 130, 132, 133, 134, 135, 136, 137, 138, 140, 142, 143, 145, 146, 149, 150, 151, 152, 153, 154, 155, 156, 158, 159, 160, 161, 162, 163, 164, 165, 166, 170, 171, 174, 175, 177, 178, 181, 183, 185, 189, 192, 196, 198, 200, 201, 202, 203, 204, 205, 206, 207, 208, 210, 211, 212, 213, 216, 218, 220, 221, 222, 223, 224, 226, 227, 228, 229, 230, 231, 234, 235, 237, 238, 239, 240, 241, 246, 247, 249, 255, 256, 257, 258, 260, 262, 263, 266, 267, 269, 270, 271, 274, 275, 278, 280, 281, 283, 286, 293, 294, 296, 297, 298, 299, 300, 301, 304, 306, 307, 308, 309, 311, 312, 315, 316, 317, 318, 320, 323, 324, 327, 329, 333, 335, 337, 343, 346, 348, 350, 352, 353, 356, 357, 358, 361, 365, 368, 370, 372, 376, 380, 381, 383, 384, 386, 388, 391, 393, 397, 399, 402, 404, 407, 408, 409, 410, 412, 421, 422, 425, 427, 428, 429, 432, 433, 434, 436, 438, 440, 441, 442, 443, 445, 449, 450, 452, 453, 455, 456, 458, 460, 466, 474, 475, 477, 479, 480, 481, 482, 483, 484, 485, 486, 487, 490, 491, 497, 498, 499, 501, 503, 504, 505, 506, 508, 512, 514]
    ...
    with open(input_path, 'r') as f:
        ...
        for line in f:
            ...
            student_update_plan = student_update_response.get("IMPROVED_STEP")
            ...
            student_update_revised_plan = student_update_response.get("REVSED_PLAN")
        ...
        print(df.shape)
        df.to_csv("Data/csv/gpt_baseline_1.csv", index=False)
