...
if __name__ == "__main__":
    ...
    process_all_instances(
        data_path_TUTOR='Data/llm_output/llama3/llama_baseline_1.jsonl',      # S→Tu
        data_path_TEACHER='Data/llm_output/llama3/llama_baseline_2.jsonl',  # S→T
        data_path_JUDGE='Data/llm_output/llama3/llama_ours.jsonl',      # S→Tu→J
        output_path='Data/llm_output/llama3/metrics_results.csv',
        use_bertscore=True,
        device='cpu'
    )