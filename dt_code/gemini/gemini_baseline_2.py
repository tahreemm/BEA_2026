...
def main():
    ...
    output_path = 'Data/llm_output/gemini/gemini_baseline_2.jsonl'
    ...
    with open(input_path, 'r') as infile:
        ...
        for line in infile:
            ...
            judge_response_raw, completion_tokens_judge, total_tokens_judge, time_taken_judge = make_judge_only_call(givens, conclusion, intermediates, student_response, cleaned_kg_final_steps)
