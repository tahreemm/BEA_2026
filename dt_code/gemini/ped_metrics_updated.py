...
if __name__ == "__main__":
    ...
    process_all_instances(
        data_path_TUTOR='Data/llm_output/gemini/gemini_baseline_1.jsonl',      # S→Tu
        data_path_TEACHER='Data/llm_output/gemini/gemini_baseline_2.jsonl',  # S→T
        data_path_JUDGE='Data/llm_output/gemini/gemini_ours.jsonl',      # S→Tu→J
        output_path='Data/llm_output/gemini/metrics_results.csv',
        use_bertscore=True,
        device='cpu'
    )